...
${nsProcess::Unload}
	...
	File "E:\My Dream\MonkeyJobTool\MonkeyJob-Tool\MonkeyJobTool\bin\Debug\HelloBotCommunication.pdb"
	File "E:\My Dream\MonkeyJobTool\MonkeyJob-Tool\MonkeyJobTool\bin\Debug\HelloBotCore.dll"
	File "E:\My Dream\MonkeyJobTool\MonkeyJob-Tool\MonkeyJobTool\bin\Debug\HelloBotCore.pdb"
	File "E:\My Dream\MonkeyJobTool\MonkeyJob-Tool\MonkeyJobTool\bin\Debug\HelloBotModuleHelper.dll"
	File "E:\My Dream\MonkeyJobTool\MonkeyJob-Tool\MonkeyJobTool\bin\Debug\HelloBotModuleHelper.pdb"
	...
	File "E:\My Dream\MonkeyJobTool\MonkeyJob-Tool\MonkeyJobTool\bin\Debug\MonkeyJobTool.pdb"
	File "E:\My Dream\MonkeyJobTool\MonkeyJob-Tool\MonkeyJobTool\bin\Debug\MonkeyJobTool.vshost.exe"
	File "E:\My Dream\MonkeyJobTool\MonkeyJob-Tool\MonkeyJobTool\bin\Debug\MonkeyJobTool.vshost.exe.config"
	File "E:\My Dream\MonkeyJobTool\MonkeyJob-Tool\MonkeyJobTool\bin\Debug\MonkeyJobTool.vshost.exe.manifest"
	...
	File "E:\My Dream\MonkeyJobTool\MonkeyJob-Tool\MonkeyJobTool\bin\Debug\Nigrimmist.Modules.pdb"
	...
	File "E:\My Dream\MonkeyJobTool\MonkeyJob-Tool\MonkeyJobTool\bin\Debug\SharedHelper.pdb"
	File "E:\My Dream\MonkeyJobTool\MonkeyJob-Tool\MonkeyJobTool\bin\Debug\SmartAssHandlerLib.dll"
	File "E:\My Dream\MonkeyJobTool\MonkeyJob-Tool\MonkeyJobTool\bin\Debug\SmartAssHandlerLib.pdb"
	File "E:\My Dream\MonkeyJobTool\MonkeyJob-Tool\MonkeyJobTool\bin\Debug\Yushko.dll"
	File "E:\My Dream\MonkeyJobTool\MonkeyJob-Tool\MonkeyJobTool\bin\Debug\Yushko.pdb"
...
Section Uninstall
	...
	Delete "$INSTDIR\HelloBotCommunication.pdb"
	Delete "$INSTDIR\HelloBotCore.dll"
	Delete "$INSTDIR\HelloBotCore.pdb"
	Delete "$INSTDIR\HelloBotModuleHelper.dll"
	Delete "$INSTDIR\HelloBotModuleHelper.pdb"
	...
	Delete "$INSTDIR\MonkeyJobTool.pdb"
	Delete "$INSTDIR\MonkeyJobTool.vshost.exe"
	Delete "$INSTDIR\MonkeyJobTool.vshost.exe.config"
	Delete "$INSTDIR\MonkeyJobTool.vshost.exe.manifest"
	Delete "$INSTDIR\NCalc.dll"
	Delete "$INSTDIR\Newtonsoft.Json.dll"
	Delete "$INSTDIR\Nigrimmist.Modules.dll"
	Delete "$INSTDIR\Nigrimmist.Modules.pdb"
	Delete "$INSTDIR\NLog.config"
	Delete "$INSTDIR\NLog.dll"
	Delete "$INSTDIR\NLog.xml"
	Delete "$INSTDIR\SharedHelper.dll"
	Delete "$INSTDIR\SharedHelper.pdb"
	Delete "$INSTDIR\SmartAssHandlerLib.dll"
	Delete "$INSTDIR\SmartAssHandlerLib.pdb"
	Delete "$INSTDIR\Yushko.dll"
	Delete "$INSTDIR\Yushko.pdb"
