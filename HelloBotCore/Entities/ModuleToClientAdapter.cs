...
namespace HelloBotCore.Entities
{
    public class ModuleToClientAdapter : ITrayClient, IBotCallback, IClient, IIntegrationClient
    {
        ...
        public IBotCallback SendMessage(Guid token, CommunicationMessage message, string title = null, AnswerBehaviourType answerType = AnswerBehaviourType.ShowText, MessageType messageType = MessageType.Default, UniqueMessageHash uniqueMsgKey = null)
        {
            _lastToken = token;
