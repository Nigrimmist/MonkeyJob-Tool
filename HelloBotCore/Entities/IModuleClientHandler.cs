...
namespace HelloBotCore.Entities
{
    public interface IModuleClientHandler
    {
        ...
        void ShowMessage(ComponentInfoBase moduleInfo, string content, string title = null, AnswerBehaviourType answerType = AnswerBehaviourType.ShowText, MessageType messageType = MessageType.Default, Guid? commandToken = null, bool useBaseClient = false);
