        ...
        private void InitBot(Action<Action> afterInitActionClbck=null)
        {
            new Thread(() =>
            {
                ...
                {   
                    ...
                    _bot.RegisterIntegrationClients(App.Instance.AppConf.SystemData.EnabledModules, (client, module, type) => App.Instance.AppConf.SystemData.ModuleEnabledForModule(client,module,type));
