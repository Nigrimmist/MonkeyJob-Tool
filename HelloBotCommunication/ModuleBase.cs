...
namespace HelloBotCommunication
{
    public abstract class ModuleBase
    {
        ...
        /// <summary>
        /// Your icon in base64 string. Should be 26x26 px. Can be in png format (transparency supported). Please, remove from result string "data:image/x-icon;base64," or similiar if exist.
        /// </summary>
