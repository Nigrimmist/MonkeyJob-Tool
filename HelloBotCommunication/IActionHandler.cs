...
namespace HelloBotCommunication
{
    public interface IActionHandler
    {
        ...
        /// </summary>
        /// <param name="command">Using command</param>
        ...
        void HandleMessage(string command,string args, object clientData, Action<string,AnswerBehaviourType> sendMessageFunc);
    }
}